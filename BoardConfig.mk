...
COMMON_GLOBAL_CFLAGS   += -DREFRESH_RATE=65 -DQCOM_NO_SECURE_PLAYBACK -DQCOM_LEGACY_OMX -DQCOM_ICS_COMPAT
COMMON_GLOBAL_CFLAGS   += -DQCOM_ICS_DECODERS -DQCOM_HARDWARE -DBINDER_COMPAT -DMISSING_GRALLOC_BUFFERS
...
# Krait optimizations(They work pretty darn good)
...
OARD_VENDOR_QCOM_GPS_LOC_API_HARDWARE_LEGACY := msm7x27a
